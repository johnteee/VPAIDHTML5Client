...
try {
    ...
    var serverName = 'log10.doubleverify.com';
    var args = new Args();
    var rand = Math.random();
    var frameUrl = 'http://' + serverName + '/visitor.aspx?query=' + escape(args._queryString) + '&srcurl=' + escape(DVURL) + '&num=44&random=' + escape(rand);
    window.lc = '<img style="width:0px;height:0px;display:none" src="' + frameUrl + '" alt="clear pixel"></img>';
    document.writeln(window.lc);
}
catch (ex) { }    
