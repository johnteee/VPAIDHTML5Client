var BAP = ((BAP && BAP.start) ? BAP : false) || (function () {
    var API = {}, 
        ...
        // _d = document
        // end shorteners
        DOMAIN_ROOT = 'https://c.evidon.com', 
    ...
    */
    ...
    function actionWrite(options, l, ow) {
        dropPixel('https://l.betrad.com/ct/' + logIdString(options) + [country, l, options.pixel_ad_w, options.pixel_ad_h, 242, options.coid, options.rev].join('/') + '/' + 'pixel.gif?v=' + version + '_' + SCRIPT_VERSION + '&ttid=' + treatment + '&d=' + domain + ow + '&r=' + Math.random());
    }
    ...
    function error(options, ec) {
        ...
        */
        ...
        if (ep[pixel] != ec) {
            ep[pixel] = ec;
            if (pixel) {
                dropPixel('https://l.betrad.com/ct/' + pixel + 'pixel.gif?e=' + ec + '&v=' + version + '_' + SCRIPT_VERSION + '&d=' + domain + '&r=' + Math.random());
            }
        }
    }
