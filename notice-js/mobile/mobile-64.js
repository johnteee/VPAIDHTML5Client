var BAP = (function () {
	...
	*/
    ...
    function noticePositionCalculate(pageId) {
        var posTop, posLeft, pixLeft, pixTop
            , lof = 2
    ...
    function noticeCreate(pageId) {
        var icon, iconWidth, iconCol, opacity, z = ''
            , expansion = ''
            , div = $('BAP-holder')
            , click = '';
        if (!div) {
